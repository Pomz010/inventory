<header class="bg-slate-800 p-2 flex justify-between">
    <span>
        <img class="h-10 w-20" src="img/navlogo.png" alt="Header logo">
    </span>
    <div class="relative">
        <span>
            <svg class="h-10 w-10 fill-current text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
