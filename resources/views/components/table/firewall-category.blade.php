...
<table id="firewall" class="table-auto border border-collapse hidden">
    <thead>
      <tr class="">
    ...
    <tbody>
      <tr>
        ...
        <td class="border px-2 py-1">Firewall</td>
        <td class="border px-2 py-1">Fortigate</td>
        <td class="border px-2 py-1">FG-61F</td>
        <td class="border px-2 py-1">FGT61FTK20029376</td>
        <td class="border px-2 py-1">APC-Tarlac Farm</td>
        <td class="border px-2 py-1">Server Room</td>
        <td class="border px-2 py-1">10.79.0.254</td>
