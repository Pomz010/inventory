...
<table id="accessPoint" class="table-auto border border-collapse hidden">
    <thead>
      <tr class="">
        ...
        <th class="border px-2 py-1">Physical Location</th>
    ...
    <tbody>
      <tr>
        ...
        <td class="border px-2 py-1">Access Point</td>
        <td class="border px-2 py-1">Unifi Ubiquiti</td>
        <td class="border px-2 py-1">UAP-AC-PRO</td>
        <td class="border px-2 py-1">7483C2B91DAF</td>
        <td class="border px-2 py-1">APC-Tarlac Farm</td>
        <td class="border px-2 py-1">Server Room</td>
        <td class="border px-2 py-1"></td>
        <td class="border px-2 py-1">74:83:C2:B9:1D:AF</td>
