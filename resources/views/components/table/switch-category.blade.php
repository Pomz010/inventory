...
<table id="switch" class="table-auto border border-collapse hidden">
    <thead>
      <tr class="">
    ...
    <tbody>
      <tr>
        ...
        <td class="border px-2 py-1">Switch</td>
        <td class="border px-2 py-1">HPE</td>
        <td class="border px-2 py-1">J9776A</td>
        <td class="border px-2 py-1">CN95FP782</td>
        <td class="border px-2 py-1">APC-Tarlac Farm</td>
        <td class="border px-2 py-1">Server Room</td>
        <td class="border px-2 py-1"></td>
        <td class="border px-2 py-1">38:21:C7:85:8B:E0</td>
